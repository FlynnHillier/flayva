...
import {
  ...
  RECIPE_ID_LENGTH,
  RECIPE_RATING_ID_LENGTH,
} from "../../../../../packages/constants/src";

// ## ENUMS ##

export const ingredientUnitEnum = pgEnum("unit", RECIPE_INGREDIENT_UNITS);
...
export const recipes = pgTable("recipes", {
  id: varchar("id")
    .primaryKey()
    .$defaultFn(() => nanoid(RECIPE_ID_LENGTH)),
...
export const recipe_ratings = pgTable("recipe_ratings", {
  id: varchar("id")
    .primaryKey()
    .$defaultFn(() => nanoid(RECIPE_RATING_ID_LENGTH)),
