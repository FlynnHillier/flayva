...
import type { RecipeTag, CreateNewPostFormSchemaType } from "@flayva/types";
import type { NestedRepositoryObject } from "@apptypes/api.types";
...
export const saveNewPost = (
  ownerId: string,
  {
    ...
    recipe: CreateNewPostFormSchemaType["recipe"];
  }
) =>
