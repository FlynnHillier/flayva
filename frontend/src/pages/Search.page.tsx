...
/**
 * SearchComponent - Main search page component
 * 
 * This component handles the search functionality for both recipes and users,
 * including filter management and responsive layout adjustments.
 */
